...
sendEthButton.addEventListener("click", () => {
	...
	async function loadWeb3() {
	  ...
	  async function loadContract() {
		...
		let address = "0x05b1365B917F1f351c99EA9F4eC4508E02318f0D";
	  ...
	  async function run() {
		...
		let result = await window.contract.methods.register(domain_name).send({ from: account, to: "0xA67f0392a9A70dEB2A0cf8Ae36017B20A8d11756", value: web3.utils.toWei(raw_amount,"ether"),  });
